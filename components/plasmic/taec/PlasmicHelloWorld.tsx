...
import PageLayout from "../../PageLayout"; // plasmic-import: -RUMoJCnYXFT/component
...
import sty from "./PlasmicHelloWorld.module.css"; // plasmic-import: Pq2wH0r1iezP/css
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicHelloWorld__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicHelloWorld__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicHelloWorld__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
  ...
  const func = function <T extends PropsType>(
    ...
    return PlasmicHelloWorld__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
